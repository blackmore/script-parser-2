...
# file = File.open("//Users/nigel/Desktop/test.txt")
# puts build_DFXL.call(LenaParser.new(file, "dtest.txt"))
...
post '/' do
   ...
   begin
      ...
      @error = "PROBLEM WITH FILE: Check that you have uploaded the correct file format" + bang
      return erb :form
   end
end
